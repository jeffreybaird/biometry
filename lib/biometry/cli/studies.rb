...
module Biometry
  module CLI
    ...
    class Studies
      ...
      # Each study is read at the gestation on its own date. A scan taken weeks
      # earlier, read at the gestation the caller supplied, yields a percentile
      # wrong by exactly those days — and wrong in the most convincing way
      # available, four standards agreeing with each other about a fetus older
